...
ActiveRecord::Schema.define(version: 2020_04_08_122851) do
  ...
  create_table "friendly_id_slugs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin", force: :cascade do |t|
